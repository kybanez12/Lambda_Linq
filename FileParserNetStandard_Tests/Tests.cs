...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = "D:/Swinburne/Lambda_Linq/data.csv";  // change to appropriate path
        private string _tsvPath = "D:/Swinburne/Lambda_Linq/data.tsv";  // change to appropriate path

        private string _writeFile = "D:/Swinburne/Lambda_Linq/writeData.txt";  // change to appropriate path
